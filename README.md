...
目前作者经过四个月断续学习 + 接近两个月的全职突击备考，考了 PTE 考试（类似雅思的英语水平测试）并拿到 63 分，对应雅思 6.5 中上，满足大部分学校留学要求以及出国技术移民的要求。虽然离十分流畅的跟 Native Speaker 交流还有一段距离，但是相比四级 442 的水平有了几倍的提升。故此编写教程进行阶段性总结，一来方便自己制定下一步训练计划，二来希望可以对同等水平有需求的朋友有所帮助。
...
这里推荐非常权威非常好的在线词典 [Cambridge Dictionary](https://dictionary.cambridge.org/us/)，里面内容十分权威，发音都是专门录制，包括英式和美式。此外还有大量例句、Family Words 等来辅助学习。

之后推荐 [Forvo](https://forvo.com/) 这个语言学习网站，对一个单词会有很多人录音，可以用来输入多种口音素材。

如果你无法适应英英词典，那么**欧路词典**可能是你更好的选择。它附带了 Forvo 的语音并且针对国内网络加速，部分单词还会有图片，然后支持很多实用功能，关联素材信息量也很大，也会有常见词对比。对比有道等其他竞品强大太多。但是这个词典也有相当多的错误，主要集中在音标和发音不对（发音估计是抓取的），以及一些翻译出来的信息不够准确。一切还是以 Cambridge Dictionary 为准。
