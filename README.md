...
此外朗文词库是非常好的词库，相比欧路内置词库权威详细的多，[强烈建议下载并安装](http://www.mrfan.org/dicts)（[可以点击这里直接下载](./assets/朗文当代英语词典英汉双解词典.mdx)）。欧路内置词库错误还是挺多的，主要集中在音标和发音不对（音标时而美式标记，时而英式，发音估计是抓取的，质量一般），以及一些翻译出来的信息不够准确。我已经反馈过 5+ 了，但是没得到什么反应，后来就懒得反馈了。
